...
export default function BoxRevealPage({ onNavigateChat, onNavigateTheorem, onNavigateHome, onNavigateRepository, onNavigateGiftBox, energyLevel, recommendations, isLoading }: BoxRevealPageProps) {
