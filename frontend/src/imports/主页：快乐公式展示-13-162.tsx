...
import svgPaths from "./svg-qg7g61fb9c";
...
function Frame20() {
  return (
    <div className="absolute h-[51.149px] left-[259px] top-[705px] w-[64px]">
      ...
      <div className="absolute flex h-[12.479px] items-center justify-center left-[5.94px] top-[36.34px] w-[26.183px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "633" } as React.CSSProperties}>
...
function Frame3() {
  return (
    <div className="absolute h-[10.168px] left-[11.41px] top-[25.28px] w-[47.734px]">
      ...
      <div className="absolute flex h-[0.706px] items-center justify-center left-[29.23px] top-[5.56px] w-[0.005px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "153.5" } as React.CSSProperties}>
        <div className="flex-none rotate-[-179.58deg]">
      ...
      <div className="absolute flex h-[0.706px] items-center justify-center left-[27.81px] top-[5.51px] w-[0.005px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "153.5" } as React.CSSProperties}>
        <div className="flex-none rotate-[-179.58deg]">
          <div className="h-[0.706px] relative w-0">
            <div className="absolute inset-[-30%_-0.21px]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 0.423676 1.1298">
      ...
      <div className="absolute flex h-[0.433px] items-center justify-center left-[27.89px] top-[4.43px] w-[1.274px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "153.5" } as React.CSSProperties}>
        <div className="flex-none rotate-[-179.58deg]">
...
function Frame9() {
  return (
    <div className="absolute h-[78.766px] left-0 top-[108px] w-[75.273px]">
      <div className="absolute inset-[0_-1.41%_-4.93%_-23.49%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 94.0172 82.6525">
          <g filter="url(#filter0_d_13_202)" id="Frame 76">
            <path d={svgPaths.p22473e80} fill="var(--fill-0, #5A7ACD)" id="Vector 10" />
...
function Frame24() {
  return (
    <div className="absolute bg-[#cad4ef] h-[180px] left-[47px] overflow-clip rounded-[10px] shadow-[0px_0px_6px_1px_rgba(91,91,91,0.25)] top-[249px] w-[300px]">
      <p className="absolute font-['Istok_Web:Regular',sans-serif] leading-[normal] left-[15px] not-italic text-[#5a7acd] text-[19.568px] top-[8px] w-[53.813px] whitespace-pre-wrap">Scene</p>
      <Frame9 />
      <p className="absolute font-['Istok_Web:Regular',sans-serif] leading-[normal] left-[59px] not-italic text-[14px] text-black top-[68px] w-[215px] whitespace-pre-wrap">Around 6 PM after work, by the window at a cafe near the office</p>
    </div>
  );
}
...
export default function Component() {
  return (
    <div className="relative size-full" data-name="主页：快乐公式展示" style={{ backgroundImage: "linear-gradient(rgba(90, 122, 205, 0.2) 19.712%, rgba(255, 162, 162, 0.2) 44.231%, rgba(90, 156, 181, 0.2) 75.962%, rgba(254, 176, 93, 0.2) 100%), linear-gradient(90deg, rgb(255, 255, 255) 0%, rgb(255, 255, 255) 100%)" }}>
      <div className="absolute flex h-[66.377px] items-center justify-center left-[261.73px] top-[693.05px] w-[81.317px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "153.5" } as React.CSSProperties}>
      ...
      <Component1 />
      <Frame23 />
      <div className="absolute backdrop-blur-[15px] bg-[rgba(157,157,157,0.1)] h-[851px] left-0 top-0 w-[393px]" />
      <Frame24 />
    </div>
  );
}