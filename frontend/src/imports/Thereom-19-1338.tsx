import svgPaths from "./svg-aytzidz1gi";
...
function Frame9() {
  return (
    <div className="absolute h-[251.21px] left-[47.5px] top-[299.53px] w-[297.695px]">
      ...
      <div className="absolute flex h-[117.992px] items-center justify-center left-[42.34px] top-[71.85px] w-[210.887px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "20" } as React.CSSProperties}>
        <div className="flex-none rotate-[11.48deg]">
      ...
      <div className="absolute flex h-[32.965px] items-center justify-center left-[58.62px] top-[43.94px] w-[79.042px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "20" } as React.CSSProperties}>
        <div className="flex-none rotate-[11.48deg]">
...
function Frame2() {
  return (
    <div className="h-[39.079px] relative w-[183.454px]">
      ...
      <div className="absolute flex h-[2.714px] items-center justify-center left-[112.34px] top-[21.37px] w-[0.02px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "20" } as React.CSSProperties}>
      ...
      <div className="absolute flex h-[2.714px] items-center justify-center left-[106.87px] top-[21.17px] w-[0.02px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "20" } as React.CSSProperties}>
        <div className="flex-none rotate-[-179.58deg]">
          <div className="h-[2.714px] relative w-0">
            <div className="absolute inset-[-30%_-0.81px]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1.62829 4.34211">
      ...
      <div className="absolute flex h-[1.664px] items-center justify-center left-[107.18px] top-[17.01px] w-[4.897px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "20" } as React.CSSProperties}>
        <div className="flex-none rotate-[-179.58deg]">
...
function Frame8() {
  return (
    <div className="absolute h-[261.918px] left-[-88.5px] top-[30.53px] w-[286.944px]">
      ...
      <div className="absolute flex h-[111.649px] items-center justify-center left-[60.34px] top-[68.49px] w-[183.139px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "140" } as React.CSSProperties}>
        <div className="flex-none rotate-[24.5deg]">
          <Frame2 />
        </div>
      </div>
      <div className="absolute flex h-[48.311px] items-center justify-center left-[89.21px] top-[128.3px] w-[77.531px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "20" } as React.CSSProperties}>
        <div className="flex-none rotate-[24.5deg]">
...
function Frame12() {
  return (
    <div className="h-[261.918px] relative w-[286.944px]">
      ...
      <div className="absolute flex h-[48.319px] items-center justify-center left-[93.92px] top-[132.07px] w-[77.53px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "20" } as React.CSSProperties}>
...
function Frame11() {
  return (
    <div className="h-[261.918px] relative w-[286.944px]">
      ...
      <div className="absolute flex h-[48.311px] items-center justify-center left-[108.83px] top-[132.95px] w-[77.531px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "20" } as React.CSSProperties}>
        <div className="flex-none rotate-[24.5deg]">
...
function Frame10() {
  return (
    <div className="absolute h-[228.753px] left-[180.5px] top-[469.53px] w-[267.752px]">
      ...
      <div className="absolute flex h-[83.469px] items-center justify-center left-[54.63px] top-[68.49px] w-[187.41px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "140" } as React.CSSProperties}>
        <div className="flex-none rotate-[-14.4deg]">
          <Frame5 />
        </div>
      </div>
      <div className="absolute flex h-[36.584px] items-center justify-center left-[123.46px] top-[124.58px] w-[79.057px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "20" } as React.CSSProperties}>
        <div className="flex-none rotate-[-14.4deg]">
          <p className="font-['Istok_Web:Regular',sans-serif] leading-[normal] not-italic relative text-[#695d52] text-[12.23px]">Feb 7th, 2026</p>
        </div>
      </div>
...
export default function Thereom() {
  return (
    <div className="bg-white relative size-full" data-name="Thereom">
      <Frame9 />
      <Frame8 />
      <div className="absolute flex h-[388.465px] items-center justify-center left-[138.5px] top-[64.53px] w-[386.334px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "160" } as React.CSSProperties}>
        <div className="flex-none rotate-[-48.45deg]">
          <Frame12 />
        </div>
      </div>
      <div className="absolute flex h-[306.921px] items-center justify-center left-[-116.5px] top-[496.53px] w-[327.324px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "160" } as React.CSSProperties}>
