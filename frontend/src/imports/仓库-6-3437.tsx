import svgPaths from "./svg-gc6ef59gqv";
...
function Button() {
  return (
    <div className="absolute bg-[#ccc] content-stretch flex h-[38.322px] items-center justify-center left-[75.01px] px-[34px] py-[8px] rounded-[12.23px] top-[105.18px] w-[119.857px]" data-name="Button">
      <p className="font-['Istok_Web:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[14.309px] text-black">Formula</p>
    </div>
  );
}
...
function Button1() {
  return (
    <div className="absolute h-[38.322px] left-[206.28px] top-[105.18px] w-[119.857px]" data-name="Button">
      <div className="absolute bg-[#e8e8e8] h-[38.322px] left-0 rounded-[12.23px] top-0 w-[119.857px]" />
      <p className="absolute font-['Istok_Web:Regular',sans-serif] leading-[normal] left-[34.25px] not-italic text-[14.309px] text-black top-[8.97px]">Thereom</p>
    </div>
  );
}
...
function Frame4() {
  return (
    <div className="h-[62.782px] relative shrink-0 w-[345.71px]">
      <div className="absolute bg-[#e8e8e8] h-[42.398px] left-0 rounded-[8.154px] top-[20.38px] w-[345.71px]" />
      <p className="absolute font-['Istok_Web:Regular',sans-serif] leading-[normal] left-[269.07px] not-italic text-[#695d52] text-[12.23px] top-0">Feb 6th, 2026</p>
      <p className="absolute font-['Itim:Regular',sans-serif] leading-[normal] left-[26.09px] not-italic text-[8.154px] text-black top-[31.8px] w-[292.712px] whitespace-pre-wrap">“Pure bliss at a cafe this afternoon: just me, my book, and the sunlight hitting the pages. I felt so calm and happy.”</p>
    </div>
  );
}
...
function Frame5() {
  return (
    <div className="h-[62.782px] relative shrink-0 w-[345.71px]">
      <div className="absolute bg-[#e8e8e8] h-[42.398px] left-0 rounded-[8.154px] top-[20.38px] w-[345.71px]" />
      <p className="absolute font-['Istok_Web:Regular',sans-serif] leading-[normal] left-[269.07px] not-italic text-[#695d52] text-[12.23px] top-0">Feb 7th, 2026</p>
    </div>
  );
}
...
function Frame6() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[21.199px] items-start left-[23.65px] top-[318.8px]">
      <Frame4 />
      <Frame5 />
      <Frame7 />
      <Frame8 />
...
function Repo() {
  return (
    <div className="absolute h-[119.343px] left-[35px] top-[181px] w-[324.835px]" data-name="Repo">
      <Frame11 />
      <Frame17 />
      <Frame18 />
...
export default function Component() {
  return (
    <div className="bg-white relative size-full" data-name="仓库">
      ...
      <Frame2 />
      <Frame6 />
      <div className="absolute bg-[#d6d6d6] h-[53.813px] left-[8.15px] rounded-[9.784px] top-[181.01px] w-[11.415px]" />
      <Repo />
      <Component1 />
    </div>
  );
