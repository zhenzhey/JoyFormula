...
import svgPaths from "./svg-18xiq38vmg";
...
function Frame2() {
  return (
    <div className="absolute h-[149.451px] left-[43.36px] top-[155.73px] w-[301.539px]">
      <div className="absolute flex h-[133.627px] items-center justify-center left-0 top-[15.82px] w-[301.539px]">
      ...
      <p className="absolute font-['Istok_Web:Regular',sans-serif] leading-[normal] left-[30.03px] not-italic text-[13.187px] text-black top-[39.14px] w-[259.341px] whitespace-pre-wrap">{`"Hello! I'm your Happiness Coach. Whenever you experience a moment of joy, feel free to tell me via voice message. I'll help you crack the code behind that happiness."`}</p>
    </div>
  );
}
...
export default function Component() {
  return (
    <div className="bg-white relative size-full" data-name="聊天建议">
      ...
      <Frame8 />
      <Frame2 />
      <div className="absolute flex h-[19.137px] items-center justify-center left-[30.17px] top-[285.84px] w-[25.912px]" style={{ "--transform-inner-width": "1184.65625", "--transform-inner-height": "154" } as React.CSSProperties}>
