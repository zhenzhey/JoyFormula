...
import svgPaths from "./svg-76jqf2m68k";
...
function Frame6() {
  return (
    <div className="bg-[#a9d66a] content-stretch flex h-[24.344px] items-center justify-center px-[33.387px] py-[3.478px] relative rounded-[6.956px] shrink-0 w-[101.551px]">
