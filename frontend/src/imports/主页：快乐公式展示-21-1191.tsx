import svgPaths from "./svg-qebtmxta3p";
    ...
    <div className="absolute h-[13.066px] left-[32.61px] top-[16.31px] w-[7.95px]">
      <div className="absolute inset-[-10.14%_-16.67%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 10.6003 15.7163">
          <g id="Frame 67">
            <path d="M1.32531 1.32495V5.74144" id="Vector 3" stroke="var(--stroke-0, #2B2A2A)" strokeLinecap="round" strokeWidth="2.6499" />
            <path d="M9.27493 1.32497V5.74147" id="Vector 4" stroke="var(--stroke-0, #2B2A2A)" strokeLinecap="round" strokeWidth="2.6499" />
            <path d={svgPaths.p381fe200} id="Vector 5" stroke="var(--stroke-0, #2B2A2A)" strokeLinecap="round" strokeWidth="2.6499" />
          </g>
        </svg>
      </div>
    </div>
    ...
    <div className="absolute h-[13.066px] left-[224.22px] top-[17.12px] w-[7.95px]">
      <div className="absolute inset-[-10.14%_-16.67%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 10.6003 15.7163">
          <g id="Frame 67">
            <path d="M1.32531 1.32495V5.74144" id="Vector 3" stroke="var(--stroke-0, #2B2A2A)" strokeLinecap="round" strokeWidth="2.6499" />
            <path d="M9.27491 1.32496V5.74145" id="Vector 4" stroke="var(--stroke-0, #2B2A2A)" strokeLinecap="round" strokeWidth="2.6499" />
            <path d={svgPaths.p381fe200} id="Vector 5" stroke="var(--stroke-0, #2B2A2A)" strokeLinecap="round" strokeWidth="2.6499" />
          </g>
        </svg>
      </div>
      ...
      <div className="absolute h-[1.198px] left-[8.84px] top-[4.42px] w-0">
        <div className="absolute inset-[-30%_-0.36px]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 0.718586 1.91623">
            <path d="M0.359293 0.359293V1.55694" id="Vector 3" stroke="var(--stroke-0, #A28F7E)" strokeLinecap="round" strokeWidth="0.718586" />
          </svg>
        </div>
      </div>
...
export default function Component() {
  return (
    <div className="bg-white relative size-full" data-name="主页：快乐公式展示">
      <div className="absolute left-[5.71px] size-[81.535px] top-[307.39px]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 81.5353 81.5353">
          <circle cx="40.7676" cy="40.7676" fill="var(--fill-0, #EBDFCE)" id="Ellipse 30" r="40.7676" />
        </svg>
      </div>
      <div className="absolute left-[49.74px] size-[87.243px] top-[375.06px]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 87.2427 87.2427">
          <circle cx="43.6214" cy="43.6214" fill="var(--fill-0, #F7E7D0)" id="Ellipse 31" r="43.6214" />
        </svg>
      </div>
      <div className="absolute left-[75.01px] size-[32.614px] top-[320.43px]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 32.6141 32.6141">
          <circle cx="16.3071" cy="16.3071" fill="var(--fill-0, #FFCECE)" id="Ellipse 32" r="16.3071" />
        </svg>
      </div>
      <div className="absolute left-[307.39px] size-[32.614px] top-[410.12px]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 32.6141 32.6141">
          <circle cx="16.3071" cy="16.3071" fill="var(--fill-0, #FFCECE)" id="Ellipse 32" r="16.3071" />
        </svg>
      </div>
      <div className="absolute left-[238.08px] size-[32.614px] top-[287.82px]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 32.6141 32.6141">
          <circle cx="16.3071" cy="16.3071" fill="var(--fill-0, #BDD3DB)" id="Ellipse 34" r="16.3071" />
        </svg>
      </div>
      <div className="absolute left-[267.44px] size-[47.29px] top-[235.64px]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 47.2905 47.2905">
          <circle cx="23.6452" cy="23.6452" fill="var(--fill-0, #CAD4EF)" id="Ellipse 35" r="23.6452" />
        </svg>
      </div>
      <div className="absolute left-[93.77px] size-[53.813px] top-[256.02px]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 53.8133 53.8133">
          <circle cx="26.9066" cy="26.9066" fill="var(--fill-0, #FFD6AA)" id="Ellipse 36" r="26.9066" />
        </svg>
      </div>
      <div className="absolute left-[291.08px] size-[97.842px] top-[299.23px]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 97.8423 97.8423">
          <circle cx="48.9212" cy="48.9212" fill="var(--fill-0, #F7E7D0)" id="Ellipse 37" r="48.9212" />
        </svg>
      </div>
      <div className="absolute h-[49.737px] left-[172.04px] top-[413.38px] w-[123.934px]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 123.934 49.7365">
          <ellipse cx="61.9668" cy="24.8683" fill="var(--fill-0, #B4B4B4)" id="Ellipse 28" rx="61.9668" ry="24.8683" />
        </svg>
      </div>
      <Frame3 />
      <div className="absolute h-[114.886px] left-[118.44px] top-[351.68px] w-[156.942px]" data-name="Vector">
      ...
      <div className="absolute left-[164.7px] size-[89.689px] top-[309.83px]" data-name="image 11">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgImage11} />
      </div>
      <div className="absolute h-[104.628px] left-[114.15px] top-[199.76px] w-[158.994px]" data-name="Vector">
      ...
      <div className="absolute flex h-[34.658px] items-center justify-center left-[134.72px] top-[425.45px] w-[72.719px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "95" } as React.CSSProperties}>
        <div className="flex-none rotate-[19.33deg]">
          <Frame4 />
        </div>
      </div>
      <div className="-translate-x-1/2 absolute font-['Istok_Web:Regular',sans-serif] leading-[0] left-[203.43px] not-italic text-[#3a3a3a] text-[14.754px] text-center top-[521.83px] w-[128.01px] whitespace-pre-wrap">
        <p className="leading-[normal] mb-0">Congratulations!</p>
        <p>
          <span className="leading-[normal]">{`You got a `}</span>
          <span className="font-['Istok_Web:Bold',sans-serif] leading-[normal] not-italic text-[#fc7371]">{`Yarn `}</span>
          <span className="font-['Istok_Web:Regular',sans-serif] leading-[normal] not-italic text-black">!</span>
        </p>
      </div>
      <p className="-translate-x-1/2 absolute font-['Istok_Web:Regular',sans-serif] leading-[normal] left-[200.58px] not-italic text-[#3a3a3a] text-[14.754px] text-center top-[611.51px] w-[265.805px] whitespace-pre-wrap">It is time to feel some warmth outside.</p>
      <Component1 />
    </div>
  );
}