import svgPaths from "./svg-qxpfech87c";
import imgImage9 from "figma:asset/a442465baf4be4743588f4589afd2d541ab38494.png";

function Frame19() {
  return (
    <div className="absolute bg-white h-[173px] leading-[normal] left-[44px] not-italic overflow-clip rounded-bl-[18.095px] rounded-br-[18.095px] shadow-[3.619px_3.619px_18.095px_1.81px_rgba(191,172,89,0.25)] top-[590px] w-[404px] whitespace-pre-wrap">
...
function Frame21() {
  return (
    <div className="absolute h-[88px] left-[85px] top-[745px] w-[326px]">
        ...
        <div className="-scale-y-100 flex-none rotate-180">
          <div className="h-[88px] relative w-[326px]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 326 88">
              <path d={svgPaths.p222656f0} fill="var(--fill-0, #FFEDD8)" id="Rectangle 25" />
            </svg>
          </div>
        </div>
      </div>
  ...
  return (
    <div className="h-[39.461px] relative shrink-0 w-[38px]" data-name="Bar chart-2">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 37.9999 39.4615">
        <g id="Bar chart-2">
          <path d={svgPaths.p21aa4380} id="Icon" stroke="var(--stroke-0, #4B4B4B)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.92307" />
        </g>
      </svg>
    </div>
  );
  ...
  return (
    <div className="h-[31px] relative shrink-0 w-[31.674px]" data-name="Info">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 31.6739 31">
        <g id="Info">
          <path d={svgPaths.p2bf97b00} id="Icon" stroke="var(--stroke-0, #4B4B4B)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.69565" />
        </g>
      </svg>
    </div>
  );
...
function Frame15() {
  return (
    <div className="absolute bg-[#cad4ef] h-[160px] left-[44px] overflow-clip rounded-[24px] top-[227px] w-[152px]">
...
function Frame16() {
  return (
    <div className="absolute bg-[#ffcece] h-[160px] left-[208px] overflow-clip rounded-[24px] top-[227px] w-[104px]">
...
function Frame17() {
  return (
    <div className="absolute bg-[#bdd3db] h-[160px] left-[324px] overflow-clip rounded-[24px] top-[227px] w-[123px]">
...
function Frame18() {
  return (
    <div className="absolute bg-[#ffd6aa] h-[160px] left-[44px] overflow-clip rounded-[24px] top-[399px] w-[202px]">
...
function Frame24() {
  return (
    <div className="absolute bg-[#ddc6ed] h-[160px] left-[258px] overflow-clip rounded-[24px] top-[399px] w-[190px]">
...
function Frame22() {
  return (
    <div className="h-[4.481px] relative w-[29.666px]">
      <p className="-translate-x-1/2 absolute font-['Itim:Regular',sans-serif] leading-none left-[14.83px] not-italic text-[#a28f7e] text-[4.481px] text-center top-0 w-[29.666px] whitespace-pre-wrap">JOYBLINDBOX</p>
      <div className="absolute h-[0.485px] left-[3.59px] top-[1.79px] w-0">
        <div className="absolute inset-[-30%_-0.15px]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 0.29128 0.776747">
            <path d="M0.14564 0.14564V0.631107" id="Vector 3" stroke="var(--stroke-0, #A28F7E)" strokeLinecap="round" strokeWidth="0.29128" />
          </svg>
        </div>
      </div>
      <div className="absolute h-[0.485px] left-[4.46px] top-[1.79px] w-0">
        <div className="absolute inset-[-30%_-0.15px]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 0.29128 0.776747">
            <path d="M0.14564 0.14564V0.631107" id="Vector 3" stroke="var(--stroke-0, #A28F7E)" strokeLinecap="round" strokeWidth="0.29128" />
          </svg>
      ...
      <div className="absolute h-[0.485px] left-[24.65px] top-[1.88px] w-0">
        <div className="absolute inset-[-30%_-0.15px]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 0.29128 0.776747">
            <path d="M0.14564 0.14564V0.631107" id="Vector 3" stroke="var(--stroke-0, #A28F7E)" strokeLinecap="round" strokeWidth="0.29128" />
          </svg>
      ...
      <div className="absolute h-[0.485px] left-[25.52px] top-[1.88px] w-0">
        <div className="absolute inset-[-30%_-0.15px]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 0.29128 0.776747">
            <path d="M0.14564 0.14564V0.631107" id="Vector 3" stroke="var(--stroke-0, #A28F7E)" strokeLinecap="round" strokeWidth="0.29128" />
          </svg>
...
function Frame26() {
  return (
    <div className="absolute bg-[#f0817f] content-stretch flex flex-col items-center justify-center left-[54px] px-[6px] py-[2px] rounded-[8.5px] size-[17px] top-[3px]">
      <p className="font-['Itim:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[10.392px] text-white">1</p>
    </div>
  );
}
...
function Frame23() {
  return (
    <div className="absolute h-[57.582px] left-[318px] top-[870px] w-[72.05px]">
      <div className="absolute h-[20.161px] left-[21.81px] top-[36.03px] w-[50.237px]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 50.2367 20.1608">
          <ellipse cx="25.1183" cy="10.0804" fill="var(--fill-0, #B4B4B4)" id="Ellipse 28" rx="25.1183" ry="10.0804" />
        </svg>
      </div>
      <div className="absolute h-[46.569px] left-[0.09px] top-[11.01px] w-[63.617px]" data-name="Vector">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 63.5585 46.5094">
          <g id="Vector">
            <path d={svgPaths.p2df46000} fill="#96816F" fillOpacity="0.8" />
            <path d={svgPaths.p1cfe9c00} fill="#CCB69B" />
            <path d={svgPaths.p29dd7a80} fill="#CCB69B" />
            <path d={svgPaths.p36b3a280} fill="var(--fill-0, #FCE6CC)" />
          </g>
        </svg>
      </div>
      <div className="absolute h-[42.411px] left-0 top-0 w-[64.448px]" data-name="Vector">
        <div className="absolute inset-[0.13%_0_0.19%_0]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 64.4484 42.2755">
            <g id="Vector">
              <path d={svgPaths.p3d89a300} fill="#96816F" />
              <path d={svgPaths.p38d08b00} fill="var(--fill-0, #B19984)" />
              <path d={svgPaths.p1ae37200} fill="var(--fill-0, #B19984)" />
              <path d={svgPaths.p2c103780} fill="var(--fill-0, #B19984)" />
            </g>
          </svg>
        </div>
      </div>
      <div className="absolute flex h-[14.048px] items-center justify-center left-[6.69px] top-[40.92px] w-[29.477px]" style={{ "--transform-inner-width": "1184.65625", "--transform-inner-height": "636" } as React.CSSProperties}>
...
function Frame8() {
  return (
    <div className="absolute h-[12.471px] left-[14px] top-[31px] w-[58.544px]">
      <p className="absolute font-['Itim:Regular',sans-serif] leading-[normal] left-[0.73px] not-italic text-[#2b2a2a] text-[8.66px] top-[1.03px]">JOYTHEOREM</p>
      <div className="absolute h-[0.866px] left-[7.34px] top-[5.58px] w-0">
        <div className="absolute inset-[-30%_-0.26px]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 0.519623 1.38566">
            <path d="M0.259812 0.259812V1.12585" id="Vector 3" stroke="var(--stroke-0, #2B2A2A)" strokeLinecap="round" strokeWidth="0.519623" />
          </svg>
        </div>
      </div>
      <div className="absolute h-[0.866px] left-[8.89px] top-[5.58px] w-0">
        <div className="absolute inset-[-30%_-0.26px]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 0.519623 1.38566">
            <path d="M0.259812 0.259812V1.12585" id="Vector 3" stroke="var(--stroke-0, #2B2A2A)" strokeLinecap="round" strokeWidth="0.519623" />
          </svg>
      ...
      <div className="absolute h-[0.52px] left-[7.4px] top-[7.49px] w-[1.559px]">
        <div className="absolute inset-[-50.01%_-16.67%_-50%_-16.67%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 2.07862 1.03932">
            <path d={svgPaths.p2e3b2800} id="Vector 5" stroke="var(--stroke-0, #2B2A2A)" strokeLinecap="round" strokeWidth="0.519623" />
          </svg>
        </div>
      </div>
      <div className="absolute flex h-[0.866px] items-center justify-center left-[35.85px] top-[6.82px] w-[0.006px]" style={{ "--transform-inner-width": "1184.65625", "--transform-inner-height": "154" } as React.CSSProperties}>
        <div className="flex-none rotate-[-179.58deg]">
          <div className="h-[0.866px] relative w-0">
            <div className="absolute inset-[-30%_-0.26px]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 0.519623 1.38566">
                <path d="M0.259812 0.259812V1.12585" id="Vector 3" stroke="var(--stroke-0, #2B2A2A)" strokeLinecap="round" strokeWidth="0.519623" />
              </svg>
      ...
      <div className="absolute flex h-[0.866px] items-center justify-center left-[34.11px] top-[6.76px] w-[0.006px]" style={{ "--transform-inner-width": "1184.65625", "--transform-inner-height": "154" } as React.CSSProperties}>
        <div className="flex-none rotate-[-179.58deg]">
          <div className="h-[0.866px] relative w-0">
            <div className="absolute inset-[-30%_-0.26px]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 0.519623 1.38566">
      ...
      <div className="absolute flex h-[0.531px] items-center justify-center left-[34.2px] top-[5.43px] w-[1.563px]" style={{ "--transform-inner-width": "1184.65625", "--transform-inner-height": "154" } as React.CSSProperties}>
        <div className="flex-none rotate-[-179.58deg]">
          <div className="h-[0.52px] relative w-[1.559px]">
            <div className="absolute inset-[-50.01%_-16.67%_-50%_-16.67%]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 2.07862 1.03932">
                <path d={svgPaths.p2e3b2800} id="Vector 5" stroke="var(--stroke-0, #2B2A2A)" strokeLinecap="round" strokeWidth="0.519623" />
              </svg>
...
function Frame25() {
  return (
    <div className="absolute bg-[#f0817f] content-stretch flex flex-col items-center justify-center left-[67px] px-[6px] py-[2px] rounded-[8.5px] size-[17px] top-[2px]">
      <p className="font-['Itim:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[10.392px] text-white">1</p>
    </div>
  );
}
...
function Frame20() {
  return (
    <div className="absolute h-[73px] left-[101px] top-[862px] w-[85.445px]">
      <div className="absolute flex h-[68.48px] items-center justify-center left-[1.53px] top-[2.26px] w-[82.381px]" style={{ "--transform-inner-width": "1184.65625", "--transform-inner-height": "0" } as React.CSSProperties}>
        <div className="flex-none rotate-[-9.22deg]">
          <div className="bg-[#a9d66a] h-[57.341px] rounded-[2.602px] shadow-[0px_1.041px_1.041px_0px_rgba(0,0,0,0.25)] w-[74.152px]" />
        </div>
      </div>
      <div className="absolute bg-[#e6e6e6] h-[57.341px] left-[5.65px] rounded-[2.602px] shadow-[0px_1.041px_1.041px_0px_rgba(0,0,0,0.25)] top-[7.83px] w-[74.152px]" />
      <Frame8 />
      <Frame25 />
    </div>
  );
...
export default function Component() {
  return (
    <div className="relative size-full" data-name="主页：快乐公式展示" style={{ backgroundImage: "linear-gradient(rgba(90, 122, 205, 0.2) 19.712%, rgba(255, 162, 162, 0.2) 44.231%, rgba(90, 156, 181, 0.2) 75.962%, rgba(254, 176, 93, 0.2) 100%), linear-gradient(90deg, rgb(255, 255, 255) 0%, rgb(255, 255, 255) 100%)" }}>
      <div className="absolute flex h-[81.409px] items-center justify-center left-[321px] top-[850px] w-[99.733px]" style={{ "--transform-inner-width": "1184.65625", "--transform-inner-height": "154" } as React.CSSProperties}>
        <div className="flex-none rotate-[20.43deg]">
          <div className="h-[54.835px] relative w-[86px]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 86 54.8354">
              <ellipse cx="43" cy="27.4177" fill="var(--fill-0, #FFD9A0)" id="Ellipse 40" rx="43" ry="27.4177" />
            </svg>
          </div>
        </div>
      </div>
      <div className="absolute h-[47px] left-[294px] top-[893px] w-[119px]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 119 47">
          <ellipse cx="59.5" cy="23.5" fill="var(--fill-0, #FFEDD8)" id="Ellipse 39" rx="59.5" ry="23.5" />
        </svg>
      </div>
      <div className="absolute h-[47px] left-[84px] top-[893px] w-[119px]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 119 47">
          <ellipse cx="59.5" cy="23.5" fill="var(--fill-0, #FFEDD8)" id="Ellipse 39" rx="59.5" ry="23.5" />
        </svg>
      </div>
      ...
      <Frame21 />
      <Component1 />
      <p className="absolute font-['Istok_Web:Regular',sans-serif] h-[31px] leading-[normal] left-[321px] not-italic text-[20px] text-black top-[175px] w-[126px] whitespace-pre-wrap">Feb 6th, 2026</p>
      <Frame14 />
      <div className="absolute left-[44px] size-[84px] top-[143px]" data-name="image 9">
      ...
      <Frame18 />
      <Frame24 />
      <p className="absolute font-['Istok_Web:Regular',sans-serif] leading-[normal] left-[314px] not-italic text-[10px] text-black top-[201px] w-[132px] whitespace-pre-wrap">This is your 96th JoyFormula.</p>
      <Frame23 />
      <Frame20 />
    </div>
  );
